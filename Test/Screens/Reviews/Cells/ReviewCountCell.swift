...
//  Test
//
//  Created by Evgeni Novik on 02.03.2025.
//
...
final class ReviewCountCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        reviewsCountLabel.frame = layout.reviewsCountTextLabelFrame
    }
...
private final class ReviewCountCellLayout {
    ...
    func height(config: Config, maxWidth: CGFloat) -> CGFloat {
        ...
        reviewsCountTextLabelFrame = CGRect(
            ...
            size: CGSize(width: width, height: config.reviewsCountText.font()?.lineHeight ?? .zero)
        )
        maxY = reviewsCountTextLabelFrame.maxY
